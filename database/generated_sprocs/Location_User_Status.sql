...
CREATE PROCEDURE `updateLocation_User_Status`(IN ID_VALUE int(10) unsigned, IN LOCATION_ID_VALUE int(10) unsigned, IN USER_ID_VALUE int(10) unsigned, IN CHECK_IN_VALUE timestamp, IN CHECK_OUT_VALUE timestamp, IN TIME_ON_LOCATION_VALUE time)
BEGIN
