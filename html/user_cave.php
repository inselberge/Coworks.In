...
$user_cave= new User_CaveModel($dbcUser);
include_once GENERATED_AGENCIES."viewuser_cave.php";
$user_caveAgency = viewUser_CaveAgency::instance($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>User Cave</h1><h3></h3></hgroup></div>';
require_once GEN_CONTROLLERS . "user_cave.php";
