...
$user_circle= new User_Circle($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>User Circle</h1><h3></h3></hgroup></div>';
require_once BROWSE_CONTROLLERS . "user_circle.php";
include BROWSE_ELEMENTS."user_circle.html";
//Check for edit mode and the id being set
if($edit_mode && $the_id){
	$user_circle->get($dbc,$the_id);
}
//Build the user_circle form
$user_circle->makeForm();
