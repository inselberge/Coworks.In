...
$link_tags= new Link_TagsModel($dbcUser);
include_once GENERATED_AGENCIES."viewlink_tags.php";
$link_tagsAgency = viewLink_TagsAgency::instance($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>Link Tags</h1><h3></h3></hgroup></div>';
require_once GEN_CONTROLLERS . "link_tags.php";
