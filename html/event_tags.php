...
$event_tags= new Event_Tags($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>Event Tags</h1><h3></h3></hgroup></div>';
require_once BROWSE_CONTROLLERS . "event_tags.php";
include BROWSE_ELEMENTS."event_tags.html";
//Check for edit mode and the id being set
if($edit_mode && $the_id){
	$event_tags->get($dbc,$the_id);
}
//Build the event_tags form
$event_tags->makeForm();
