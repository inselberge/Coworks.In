...
$user_bio= new User_BioModel($dbcUser);
include_once GENERATED_AGENCIES."viewuser_bio.php";
$user_bioAgency = viewUser_BioAgency::instance($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>User Bio</h1><h3></h3></hgroup></div>';
require_once GEN_CONTROLLERS . "user_bio.php";
