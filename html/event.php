...
include_once GENERATED_AGENCIES."viewevent.php";
$eventAgency = viewEventAgency::instance($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>Event</h1><h3></h3></hgroup></div>';
require_once GEN_CONTROLLERS . "event.php";
