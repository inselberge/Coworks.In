...
$user_application= new User_Application($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>User Application</h1><h3></h3></hgroup></div>';
require_once BROWSE_CONTROLLERS . "user_application.php";
include BROWSE_ELEMENTS."user_application.html";
//Check for edit mode and the id being set
if($edit_mode && $the_id){
	$user_application->get($dbc,$the_id);
}
//Build the user_application form
$user_application->makeForm();
