...
$question= new QuestionModel($dbcUser);
include_once GENERATED_AGENCIES."viewquestion.php";
$questionAgency = viewQuestionAgency::instance($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>Question</h1><h3></h3></hgroup></div>';
require_once GEN_CONTROLLERS . "question.php";
