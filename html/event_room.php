...
$event_room= new Event_RoomModel($dbcUser);
include_once GENERATED_AGENCIES."viewevent_room.php";
$event_roomAgency = viewEvent_RoomAgency::instance($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>Event Room</h1><h3></h3></hgroup></div>';
require_once GEN_CONTROLLERS . "event_room.php";
