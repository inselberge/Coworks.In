...
$user_company= new User_Company($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>User Company</h1><h3></h3></hgroup></div>';
require_once BROWSE_CONTROLLERS . "user_company.php";
include BROWSE_ELEMENTS."user_company.html";
//Check for edit mode and the id being set
if($edit_mode && $the_id){
	$user_company->get($dbc,$the_id);
}
//Build the user_company form
$user_company->makeForm();
