...
$user_invite= new User_Invite($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>User Invite</h1><h3></h3></hgroup></div>';
require_once BROWSE_CONTROLLERS . "user_invite.php";
include BROWSE_ELEMENTS."user_invite.html";
//Check for edit mode and the id being set
if($edit_mode && $the_id){
	$user_invite->get($dbc,$the_id);
}
//Build the user_invite form
$user_invite->makeForm();
