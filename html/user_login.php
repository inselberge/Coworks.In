...
$user_login= new User_LoginModel($dbcUser);
include_once GENERATED_AGENCIES."viewuser_login.php";
$user_loginAgency = viewUser_LoginAgency::instance($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>User Login</h1><h3></h3></hgroup></div>';
require_once GEN_CONTROLLERS . "user_login.php";
