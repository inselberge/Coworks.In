...
$billing_plan= new Billing_PlanModel($dbcUser);
include_once GENERATED_AGENCIES."viewbilling_plan.php";
$billing_planAgency = viewBilling_PlanAgency::instance($dbcUser);
echo '<div class="hero-unit shadow"><hgroup><h1>Billing Plan</h1><h3></h3></hgroup></div>';
require_once GEN_CONTROLLERS . "billing_plan.php";
